...
<h3 align="center">Soy un Frontend que está buscando desarrollarse constantemente y adquirir conocimiento nuevo.</h3>

- 🌱 Actualmente estoy aprendiendo **React, NodeJS, Curso(Oracle one - Alura Latam)**

- 👯 Estoy buscando trabajar en **Desarrollo Web**

- 💬 Intereses **Html, Css, Javascript, React, Pseint Python.**
